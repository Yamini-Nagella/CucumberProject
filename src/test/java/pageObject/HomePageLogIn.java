...
public class HomePageLogIn extends HomePageLogInUi {
	...
	public void enter(String Uid, String Pw) throws ReusableComponentException, Exception {
	...
	public void clicklogin() throws ReusableComponentException, Exception {
		WebDriverSupport.click(driver, signin, "Account Log in", "sign in button", log, test);
		Thread.sleep(5000);
	}
	public void verify(String name) throws IOException, PageObjectException {
