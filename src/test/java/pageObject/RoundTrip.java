...
public class RoundTrip extends RoundTripUi{
		...
		public void from(String src) throws ReusableComponentException, Exception {
		...
		public void to(String destin) throws ReusableComponentException, Exception {
		...
		public void starting(String month1, String day1) throws ReusableComponentException, Exception {
		...
		public void Returns(String month2, String day2) throws ReusableComponentException, Exception {
