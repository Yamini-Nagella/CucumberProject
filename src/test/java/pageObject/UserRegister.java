...
public class UserRegister extends UserRegisterUi{
	...
	public void signin() throws ReusableComponentException, Exception {
	...
	public void details(String uname, String num, String uemail, String upass, String cpass) throws ReusableComponentException, Exception {
	...
	public void register() throws ReusableComponentException, Exception {
		WebDriverSupport.click(driver, register, "Account Log in", "Register Button", log, test);
		Thread.sleep(5000);
	}
	public void verify(String uname) throws IOException, PageObjectException {
